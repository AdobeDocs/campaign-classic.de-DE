...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <span class="uicontrol">NmsDelivery_FromAddressMasken</span><br /> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> (Kompatibilitätsmodus installieren:Build&gt;6000) Wenn "1"eingegeben wird, aktiviert diese Option den Kompatibilitätsmodus für gespeicherte Kennwörter. Durch Ändern dieser Option wird die Verwendung alter in der Datenbank gespeicherter Kennwörter verhindert.<br /> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <span class="uicontrol">XtkSecurity_Allow_PrivilegeEskalation</span><br /> </td> 
