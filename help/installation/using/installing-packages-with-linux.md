...
* Installieren Sie OpenSSL 1.0 (weitere Informationen finden Sie unter [Bibliotheken](../../installation/using/prerequisites-of-campaign-installation-in-linux.md#libraries)):
