...
# Migrieren zum Adobe Analytics Connector {#acc-aa-faq}
...
Am 1. August 2021 wird Adobe Campaign Classic aus der veralteten Data Connectors-Benutzeroberfläche entfernt. Vorhandene Campaign-Integrationen werden jedoch bis zum 1. März 2022 weiterhin Daten erfassen und an Adobe Analytics weitergeben können. Am 1. März 2022 wird die Integration die Erfassung und Weitergabe von Daten an Adobe Analytics einstellen.
...
Sobald alle Instanzen das Upgrade erhalten haben, können Sie [die neue Integration](../platform/using/adobe-analytics-connector.md) in Adobe Analytics Connector implementieren und einen nahtlosen Übergang sicherstellen.
