...
In diesem Anwendungsbeispiel vergleichen wir zwei E-Mail-Versandinhalte mithilfe eines Zielgruppenbestimmungs-Workflows. Nachricht und Text sind bei beiden Sendungen identisch, nur das Layout ändert sich.
...
Die Kriterien zur Auswahl der Siegerversion können je nach Bedarf geändert werden. Hierbei kann es sich beispielsweise um die Öffnungsrate, Klickrate, Anmelderate oder Reaktivität etc. handeln.
