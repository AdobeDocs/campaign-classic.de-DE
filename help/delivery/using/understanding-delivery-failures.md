...
>[!NOTE]
>
>Eine umfassende Anleitung zum Verständnis von fehlgeschlagenen Sendungen finden Sie auf der Seite [Campaign v8 - Informationen zu fehlgeschlagenen Sendungen](https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/send/monitor/delivery-failures) . Diese Inhalte gelten für Benutzende von Campaign Classic v7 und Campaign v8 und umfassen:
>
>* Typen und Ursachen für fehlgeschlagene Sendungen (Hard, Soft, Ignoriert)
>* Synchrone und asynchrone Fehler
>* Qualifizierung von Bounce Messages
>* Fehlertypen für E-Mail, Push-Benachrichtigung und SMS
>* Verwaltung von Wiederholungen und Gültigkeitszeiträume
>* Fehlerbehebung bei häufigen Versandfehlern
>
>Auf dieser Seite wird die **Campaign Classic v7-spezifische** für die Bounce-Message-Verwaltung in Hybrid- und On-Premise-Bereitstellungen dokumentiert.
...
## Bounce-Message-Konfiguration {#v7-bounce-mail-config}
