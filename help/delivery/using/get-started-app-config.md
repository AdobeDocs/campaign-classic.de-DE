...
* Erstellen Sie einen Versand für [iOS](create-notifications-ios.md) und [Android](create-notifications-android.md).
...
## Installieren Sie das Paket {#installing-package-ios}
