...
* Wenn Sie Schübe verwenden, stellen Sie sicher, dass jede Schübe genügend Zeit zum Beenden hat, bevor die nächste ausgelöst wird. Siehe die [Campaign v8-Dokumentation](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/validate/configure-and-send.html#sending-using-multiple-waves){target="_blank"}.
