...
Wenn Sie Adobe Managed Services verwenden, können Sie von der Kampagne [!DNL Gold Standard] profitieren. Weiterführende Informationen hierzu finden Sie in [diesem Artikel](../../rn/using/gs-overview.md).
