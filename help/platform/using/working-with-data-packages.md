...
Adobe Campaign ermöglicht den Export oder Import von Plattformkonfigurationen und Daten mithilfe eines Paketsystems. Pakete können verschiedene Arten von Konfigurationen und Elementen enthalten, gefiltert oder ungefiltert.
...
>[!NOTE]
>
>Weitere Informationen zu Daten-Packages finden Sie in der [Dokumentation zu Campaign v8.](https://experienceleague.adobe.com/de/docs/campaign/campaign-v8/developer/packages){target=_blank}
