...
A/B-Test ist eine Funktion, mit der der Benutzer zwei bis drei E-Mail-Varianten definieren kann: Jede Variante wird an Populationsproben gesendet, um zu bestimmen, welches das beste Ergebnis erzielt. Sobald die Gewinnervariante feststeht, wird sie an die verbleibende Zielpopulation gesendet.
