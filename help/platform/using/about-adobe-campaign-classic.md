...
description: Über Adobe Campaign Classic
...
# Über Adobe Campaign Classic{#about-adobe-campaign-classic}
...
>[!NOTE]
>
>Adobe Campaign Classic ist in v6.11 und v7 verfügbar. Außer wenn etwas anderes angegeben ist, gelten die Hilfematerialien für beide Versionen und die jeweils letzte Buildnummer. Screenshots beziehen sich auf Campaign Classic v7.
...
* [Kanäle](../../delivery/using/communication-channels.md): Konzeption und Durchführung von Sendungen auf unterschiedlichen Kanälen (E-Mail, SMS, LINE, Mobile App, Briefpost)
