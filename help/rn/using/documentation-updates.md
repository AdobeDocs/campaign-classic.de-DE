...
Der Abschnitt zu den Versionshinweisen wurde aktualisiert und enthält jetzt Informationen zu den in Version 7.4.1 verfügbaren Verbesserungen, Kompatibilitätsaktualisierungen und Patches. [Weitere Informationen](latest-release.md)
...
Die Seite „Hilfe und Support-Optionen“ für Campaign Classic wurde in die Hauptdokumentation integriert. [Mehr dazu](../../support.md)
...
* [Konfigurieren und Bereitstellen einer Versandvorlage](../../delivery/using/about-templates.md)
...
* [Verwalten von Testadressen und Testsendungen in einer E-Mail](https://experienceleague.adobe.com/docs/campaign/campaign-v8/send/create-message.html?lang=de#target-population){target="_blank"}.
