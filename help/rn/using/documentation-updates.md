...
Die Option &quot;WdbcOptions_TempDbName&quot;wurde zur Liste der Campaign-Optionen hinzugefügt. [Mehr dazu](../../installation/using/configuring-campaign-options.md)
...
Es wurde ein neuer Abschnitt hinzugefügt, in dem beschrieben wird, wie Sie einen Workflow im Status &quot;Beginn so bald wie möglich&quot;in einem Campaign beheben können. [mehr dazu](../../production/using/workflow-execution.md#start-as-soon-as-possible-in-campaigns)

Die neuen Optionen &quot;NmsOperation_DeliveryVorbereitungsfenster&quot;und &quot;WdbcKillSessionPolicy&quot;wurden zur Liste der Campaign-Optionen hinzugefügt. [Mehr dazu](../../installation/using/configuring-campaign-options.md)
...
Es wurde ein Abschnitt mit einer Beschreibung der Deinstallationsschritte des Campaign-Servers hinzugefügt. [Mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/INS_Appendices_Uninstalling_Campaign.html)
...
Es wurden zwei neue Optionen zur Liste der Campaign-Optionen hinzugefügt: XtkSecurity_Restrict_EditXML und NmsOperation_OperationMgtDebug.
...
Das Verfahren zur Einrichtung des Campaign-Domänennamens wurde verbessert und aktualisiert. [Mehr dazu](https://helpx.adobe.com/campaign/kb/domain-name-delegation.html)
...
Das Handbuch zur Hardware-Größe des Campaigns wurde aktualisiert. [Mehr dazu](https://helpx.adobe.com/campaign/kb/hardware-sizing-guide.html)
...
Die Hilfeseite &quot;Gemeinsame Frage&quot;enthält jetzt Informationen zu den verfügbaren Sprachen des Campaigns, zur Webformularübersetzung und zu mehrsprachigen E-Mails. [Mehr dazu](../../platform/using/common-questions.md)
...
Integrationshandbuch für Campaign- und Adobe Experience Cloud-Lösungen wurde aktualisiert und neu organisiert. [Mehr dazu](../../integrations/using/about-campaign-integrations.md)
...
Die Campaign-Integration mit Adobe Analytics - Data Connector wurde verbessert und neu organisiert. [Mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/PTF_Connectors_Adobe_Analytics_Data_Connector.html)
...
Es wurde ein neuer Bereich &quot;Tutorials&quot;hinzugefügt, der den Zugriff auf Hilfedokumente, Anleitungen, Beispiele und Campaigne erleichtern soll. [Mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/PTF_Starting_with_Adobe_Campaign_Tutorials.html)
...
Campaign Compatibility Matrix wurde aktualisiert. [Mehr dazu](https://helpx.adobe.com/campaign/kb/compatibility-matrix.html)
...
Die Installationsdokumentation wurde aktualisiert, um zu erwähnen, dass pgcrypto jetzt für die Installation von Campaignen bei Verwendung von PostreSQL erforderlich ist. [Mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/INS_Installing_Campaign_in_Linux__Prerequisites.html#Database_access_layers)
