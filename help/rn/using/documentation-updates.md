...
Die [Sicherheits](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/security.html)-, [Bereitstellungs](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliverability.html) - und [GDPR](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/ACC_GDPR.html) -Anleitungen wurden aktualisiert.
...
Wichtige Schritte beim Erstellen und Senden einer Bereitstellung wurden in einem neuen Abschnitt zusammengefasst, wobei bei Bedarf auf die verschiedenen Kanäle verwiesen wird. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/DLV_About_deliveries_and_channels_Key_steps_when_creating_a_delivery.html)
...
In den [Versionshinweisen](https://docs.campaign.adobe.com/doc/AC/en/RN.html) und [veralteten Versionshinweisen](http://docs.campaign.adobe.com/doc/AC/en/RN_legacy.html)wurde eine Warnung für zurückgerufene Builds hinzugefügt. Kumulative Builds für 17.9, 18.4 und 18.6 wurden ebenfalls hinzugefügt.
...
Das Handbuch [GDPR](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/ACC_GDPR.html) für die ersten Schritte wurde aktualisiert und enthält Informationen zum externen Aufrufen der API und dazu, wie mit queryDef der Status abgefragt und die GDPR-Datei heruntergeladen werden kann.
...
Die Hilfeseite &quot;Allgemeine Fragen&quot;enthält jetzt Informationen zu den verfügbaren Kampagnensprachen, zur Webformular-Übersetzung und zu mehrsprachigen E-Mails. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/PTF_Starting_with_Adobe_Campaign_Common_questions.html)
...
Die Hilfeseite [Häufige Fragen](https://docs.campaign.adobe.com/doc/AC/en/PTF_Starting_with_Adobe_Campaign_Common_questions.html) enthält jetzt Links zur Seite Fehlermeldungen.
...
Integrationshandbuch für Kampagnen und Adobe Experience Cloud-Lösungen wurde aktualisiert und neu organisiert. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/ITG_Campaign_integrations_About_Campaign_integrations.html)
...
Das Handbuch &quot;Best Practices für die Bereitstellung - Erste Schritte&quot;wurde aktualisiert. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliveryBestPractices.html)
...
Die Seite &quot;Häufige Fragen/FAQ&quot;von Campaign Classic wurde aktualisiert. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/PTF_Starting_with_Adobe_Campaign_Common_questions.html)

## 18.4 - 24/04/2018{#release-18-4}

**Neue Funktionen in der Version**

EU-Datenschutz-Grundverordnung (DSGVO) – [mehr dazu](https://docs.campaign.adobe.com/doc/AC/getting_started/EN/ACC_GDPR.html)
...
Eine neue Seite mit den häufigsten Fragen zu Campaign Classic wurde hinzugefügt. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/PTF_Starting_with_Adobe_Campaign_Common_questions.html)
...
Einige bekannte Einschränkungen und Best Practices für RDBMS wurden hinzugefügt. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/en/INS_Prerequisites_and_recommendations__Database.html)
...
Die Liste der technischen Arbeitsabläufe wurde aktualisiert. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/en/WKF_Technical_workflows_About_technical_workflows.html)
...
Die Dokumentation zur Berechnung der Berichtsindikatoren wurde aktualisiert. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/RPT_Accessing_built-in_reports_Reports_on_deliveries.html#Indicator_calculation)
...
Neue Abfragebeispiele wurden hinzugefügt. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/en/WKF_Use_cases_Designing_queries.html#Filtering_duplicated_recipients)

Leitfaden zu Best Practices zur Bereitstellung wurde aktualisiert. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/getting_started/EN/deliveryBestPractices.html)
...
Best Practice zum Hinzufügen eines angehaltenen Workflows [mehr dazu](http://docs.campaign.adobe.com/doc/AC/en/WKF__General_operation_Executing_a_workflow.html)

Neues Verfahren zur Vorverarbeitung von Dateien beim Import und bei der Nachverarbeitung beim Exportieren von Daten in einen Workflow. Lies [hier](http://docs.campaign.adobe.com/doc/AC/en/WKF__General_operation_Importing_data.html)!
...
Ein neuer Einstieg in die Build-Aktualisierung wurde hinzugefügt. [mehr dazu](http://docs.campaign.adobe.com/doc/AC/getting_started/EN/buildUpgrade.html)
...
Sie erfahren, wie Sie einen Versand an Empfänger durchführen, die aus einer externen Datei geladen wurden, ohne die Datenbank zu aktualisieren. [mehr dazu](https://docs.campaign.adobe.com/doc/AC/en/DLV_Sending_emails_Identifying_target_populations.html#Selecting_external_recipients)
