...
>[!CAUTION]
>
>Diese Integrationen erfolgen parallel. Lesen Sie aufmerksam die folgenden Informationen, bevor Sie irgendeine Konfiguration vornehmen.
...
Vor der Integration von AEM Assets mit Adobe Campaign muss zunächst die Integration von Adobe Experience Manager und Adobe Campaign erfolgen. Diese Konfiguration erfordert hauptsächlich Folgendes:
...
Nach der Integration können Sie eine neue Versandvorlage in Adobe Campaign konfigurieren, um die AEM Assets-Bibliothek zu verwenden. Gehen Sie dazu wie folgt vor:
