...
Die Registerkarte **[!UICONTROL Variablen]** enthält die Liste der im Bericht konfigurierten Variablen. Diese werden im Kontext des Berichts angegeben und können in den Berechnungen verwendet werden.
