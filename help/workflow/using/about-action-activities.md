...
* **Versand bearbeiten**: erlaubt es, einen Versand zu starten, zu stoppen oder anzuhalten. Weitere Informationen hierzu finden Sie im Abschnitt [Versand bearbeiten](delivery-control.md).
...
* **Lokale Validierung**: wird im dezentralen Marketing (optionales Modul) zur Konfiguration von Validierungen und Zielgruppenbestimmungs-Benachrichtigungen verwendet. Siehe [Lokale Validierung](local-approval.md).
