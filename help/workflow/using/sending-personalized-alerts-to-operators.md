...
>[!NOTE]
>
>Mit dem Befehl **[!UICONTROL &lt;%= item.target.recipient.@fieldName %>]** können Sie eines der Felder hinzufügen, die der Instanzvariablen über die Aktivität **[!UICONTROL JavaScript-Code}]** wurden.\
