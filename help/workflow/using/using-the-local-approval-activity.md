...
1. Behalten Sie im Feld **[!UICONTROL Versandtitel]** den Standardausdruck bei (Compute String des Versands). Auf diese Weise wird in der Feadback-Benachrichtigung der ursprüngliche Versandtitel verwendet.
