...
* [Überwachen von Workflows](../../workflow/using/supervising-workflows.md)
...
* [Abfrage der Empfängertabelle](../../workflow/using/querying-recipient-table.md)
* [Abfrage von Versandinformationen](../../workflow/using/querying-delivery-information.md)
...
* [Aufrufen von Instanzvariablen in Abfragen](../../workflow/using/javascript-scripts-and-templates.md#calling-an-instance-variable-in-a-query)
* [Anwenden einer prozentualen Aufspaltung auf eine Population](../../workflow/using/javascript-scripts-and-templates.md#example)
