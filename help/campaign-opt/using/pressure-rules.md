...
>[!NOTE]
>
>Bei Änderung der Definition einer Typologieregel können Sie eine **Simulation** erstellen, um ihren Einfluss auf die Sendungen, bei denen sie angewendet wird, zu kontrollieren, und die Auswirkungen der Sendungen untereinander zu beobachten. Weitere Informationen hierzu finden Sie unter [Kampagnensimulationen](campaign-simulations.md).
