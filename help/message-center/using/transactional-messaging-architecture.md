...
1. Installieren Sie den benötigten Kanal, z. B. den Kanal **Mobil**, mithilfe des Package-Import-Assistenten (**[!UICONTROL Tools > Erweitert > Package importieren.. > Adobe Campaign Package]**).
