...
+ Versionshinweise {#release-notes}
   ...
   + {hide-from-toc}[Dokumentationsaktualisierungen – AUSGEBLENDET](rn/using/documentation-updates.md)
+ Erste Schritte {#getting-started}
   ...
   + [Erkunden der Campaign-Benutzeroberfläche](platform/using/adobe-campaign-workspace.md)
   + {hide-from-toc}[Verwenden des Campaign-Explorers – AUSGEBLENDET](platform/using/adobe-campaign-explorer.md)
   + {hide-from-toc}[Durchsuchen und Anpassen von Listen – AUSGEBLENDET](platform/using/adobe-campaign-ui-lists.md)
   + {hide-from-toc}[Auflistungen – AUSGEBLENDET](platform/using/managing-enumerations.md)
   ...
   + {hide-from-toc}[Glossar – AUSGEBLENDET](platform/using/ac-glossary.md)
   + Datenschutz {#privacy}
   ...
   + Profil-Management {#profile-management}
      ...
      + {hide-from-toc}[Bearbeiten eines Profils – AUSGEBLENDET](platform/using/editing-a-profile.md)
      + {hide-from-toc}[Hinzufügen von Profilen – AUSGEBLENDET](platform/using/adding-profiles.md)
      + {hide-from-toc}[Verwalten von Profilen – AUSGEBLENDET](platform/using/managing-profiles.md)
      + [Daten-Update](platform/using/updating-data.md)
      + {hide-from-toc}[Importieren und Exportieren von Profilen – AUSGEBLENDET](platform/using/exporting-and-importing-profiles.md)
   ...
   + Filtern von Daten {#filtering-data}
      + {hide-from-toc}[Filteroptionen – AUSGEBLENDET](platform/using/filtering-options.md)
      + {hide-from-toc}[Erstellen von Filtern – AUSGEBLENDET](platform/using/creating-filters.md)
      + {hide-from-toc}[Anwendungsfall – Ausgeblendet](platform/using/use-case.md)
   + {hide-from-toc}[Schritte zum Erstellen einer Abfrage – AUSGEBLENDET](platform/using/steps-to-create-a-query.md)
   + {hide-from-toc}[Definieren von Filterbedingungen – AUSGEBLENDET](platform/using/defining-filter-conditions.md)
   + Berechtigungen {#permissions}
      ...
      + {hide-from-toc}[Verwalten des Zugriffs auf Ordner – AUSGEBLENDET](platform/using/access-management-folders.md)
   + CRM-Connectoren {#connectors}
      + [Erste Schritte mit CRM-Connectoren](platform/using/crm-connectors.md)
      + {hide-from-toc}[Verbinden mit Microsoft Dynamics 365](platform/using/crm-ms-dynamics.md)
      + {hide-from-toc}[Verbinden mit Salesforce.com](platform/using/crm-sfdc.md)
      + {hide-from-toc}[Synchronisieren von Daten mit dem CRM](platform/using/crm-data-sync.md)
   + {hide-from-toc}[Hilfe- und Support-Optionen – AUSGEBLENDET](support.md)
+ Erstellen und Senden von Nachrichten {#sending-messages}
   ...
   + {hide-from-toc}[Versandeinstellungen – AUSGEBLENDET](delivery/using/delivery-settings.md)
   + Schnellstart {#key-steps-when-creating-a-delivery}
      + {hide-from-toc}[Erste Schritte mit Sendungen – AUSGEBLENDET](delivery/using/steps-about-delivery-creation-steps.md)
      + {hide-from-toc}[Erstellen und Identifizieren eines Versands – AUSGEBLENDET](delivery/using/steps-create-and-identify-the-delivery.md)
      + {hide-from-toc}[Definieren der Zielgruppe – AUSGEBLENDET](delivery/using/steps-defining-the-target-population.md)
      + {hide-from-toc}[Überprüfen des Versands – AUSGEBLENDET](delivery/using/steps-validating-the-delivery.md)
      + {hide-from-toc}[Durchführen des Versands – AUSGEBLENDET](delivery/using/steps-sending-the-delivery.md)
      + {hide-from-toc}[Best Practices beim Versand – AUSGEBLENDET](delivery/using/delivery-best-practices.md)
   + Best Practices für den Versand {#delivery-bestpractices}
      + {hide-from-toc}[Optimieren des Versands – AUSGEBLENDET](delivery/using/optimize-delivery.md)
      + {hide-from-toc}[Verwenden von Vorlagen – AUSGEBLENDET](delivery/using/use-templates.md)
      + {hide-from-toc}[Erstellen personalisierter Inhalte – AUSGEBLENDET](delivery/using/design-and-personalize.md)
      + {hide-from-toc}[Definieren der richtigen Zielgruppe – AUSGEBLENDET](delivery/using/define-the-right-audience.md)
      + {hide-from-toc}[Prüfen vor dem Senden – AUSGEBLENDET](delivery/using/check-before-sending.md)
   + [Senden von E-Mails](delivery/using/about-email-channel.md)
   + Senden von E-Mails {#sending-emails}
      + {hide-from-toc}[Erstellen eines E-Mail-Versands – AUSGEBLENDET](delivery/using/creating-an-email-delivery.md)
      + {hide-from-toc}[Definieren des E-Mail-Inhalts – AUSGEBLENDET](delivery/using/defining-the-email-content.md)
      + {hide-from-toc}[Definieren interaktiver Inhalte – AUSGEBLENDET](delivery/using/defining-interactive-content.md)
      + Senden des E-Mail-Versands {#sending-an-email}
         + {hide-from-toc}[Wichtigste Schritte zum Senden einer E-Mail – AUSGEBLENDET](delivery/using/sending-messages.md)
         + {hide-from-toc}[E-Mail-Parameter – AUSGEBLENDET](delivery/using/email-parameters.md)
         + {hide-from-toc}[Senden auf japanischen Mobilgeräten – AUSGEBLENDET](delivery/using/sending-emails-on-japanese-mobiles.md)
      + {hide-from-toc}[Anhängen von Dateien – AUSGEBLENDET](delivery/using/attaching-files.md)
   + Senden von SMS {#sending-messages-on-mobiles}
      ...
      + {hide-from-toc}[Erstellen einer SMS – AUSGEBLENDET](delivery/using/sms-create.md)
      + {hide-from-toc}[Migrieren zum erweiterten allgemeinen SMPP-Connector](delivery/using/unsupported-connector-migration.md)
   ...
   + Senden von Push-Benachrichtigungen {#sending-push-notifications}
      + {hide-from-toc}[Integrieren des Campaign-SDK in die App](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
      + Konfigurieren der App{#configure-the-mobile-app}
         + {hide-from-toc}[Erste Schritte bei der App-Konfiguration – AUSGEBLENDET](delivery/using/get-started-app-config.md)
         + {hide-from-toc}[Konfigurationsschritte für iOS – AUSGEBLENDET](delivery/using/configuring-the-mobile-application.md)
         + {hide-from-toc}[Konfigurationsschritte für Android – AUSGEBLENDET](delivery/using/configuring-the-mobile-application-android.md)
      + Erstellen einer Push-Benachrichtigung{#create-a-push-msg}
         + {hide-from-toc}[Erstellen einer Push-Benachrichtigung für iOS – AUSGEBLENDET](delivery/using/create-notifications-ios.md)
         + {hide-from-toc}[Erstellen einer Push-Benachrichtigung für Android – AUSGEBLENDET](delivery/using/create-notifications-android.md)
      + {hide-from-toc}[Fehlerbehebung – AUSGEBLENDET](delivery/using/troubleshooting.md)
   + [Senden von Briefpost](delivery/using/about-direct-mail-channel.md)
   + Senden von Briefpost {#sending-direct-mail}
      + {hide-from-toc}[Erstellen eines Briefpost-Versands – AUSGEBLENDET](delivery/using/creating-a-direct-mail-delivery.md)
      + {hide-from-toc}[Definieren des Briefpost-Inhalts – AUSGEBLENDET](delivery/using/defining-the-direct-mail-content.md)
      + {hide-from-toc}[Validieren – AUSGEBLENDET](delivery/using/validating.md)
   + Verwenden von Versandvorlagen {#using-delivery-templates}
      + {hide-from-toc}[Arbeiten mit Versandvorlagen – AUSGEBLENDET](delivery/using/about-templates.md)
      + {hide-from-toc}[Erstellen einer Versandvorlage – AUSGEBLENDET](delivery/using/creating-a-delivery-template.md)
      + {hide-from-toc}[Auswählen eines Zielgruppen-Mappings – AUSGEBLENDET](delivery/using/selecting-a-target-mapping.md)
      + {hide-from-toc}[Erstellen eines Versands aus einer Vorlage – AUSGEBLENDET](delivery/using/creating-a-delivery-from-a-template.md)
   + Personalisieren von Sendungen {#personalizing-deliveries}
      + [Über Personalisierung](delivery/using/about-personalization.md)
      + {hide-from-toc}[Personalisierungsfelder – AUSGEBLENDET](delivery/using/personalization-fields.md)
      + {hide-from-toc}[Gestaltungsbausteine – AUSGEBLENDET](delivery/using/personalization-blocks.md)
      + {hide-from-toc}[Bedingter Inhalt – AUSGEBLENDET](delivery/using/conditional-content.md)
      + {hide-from-toc}[Personalisierte Coupons – AUSGEBLENDET](delivery/using/personalized-coupons.md)
      + {hide-from-toc}[Generieren personalisierter PDF-Dokumente – AUSGEBLENDET](delivery/using/generating-personalized-pdf-documents.md)
      + {hide-from-toc}[Personalisieren der Emoticon-Liste](delivery/using/customizing-emoticon-list.md)
   + Verwenden von Testadressen {#using-seed-addresses}
      ...
      + [Anwendungsfall: Auswählen von Testadressen nach Kriterien](delivery/using/use-case-selecting-seed-addresses-on-criteria.md)
      + [Anwendungsfall: Konfigurieren der Feld-Ersetzung](delivery/using/use-case-configuring-the-field-substitution.md)
...
+ Orchestrieren von Marketing-Kampagnen {#orchestrating-campaigns}
   + {hide-from-toc}[Über Kampagnenoptimierung – AUSGEBLENDET](campaign-opt/using/about-campaign-optimization.md)
   + Über Marketing-Kampagnen {#about-marketing-campaigns}
      + {hide-from-toc}[Entwerfen von Marketing-Kampagnen – AUSGEBLENDET](campaign/using/designing-marketing-campaigns.md)
      + {hide-from-toc}[Zugreifen auf Marketing-Kampagnen – AUSGEBLENDET](campaign/using/accessing-marketing-campaigns.md)
   + Orchestrieren von Kampagnen {#orchestrate-campaigns}
      + {hide-from-toc}[Erste Schritte mit Marketing-Kampagnen – AUSGEBLENDET](campaign/using/setting-up-marketing-campaigns.md)
      + {hide-from-toc}[Erstellen und Konfigurieren von Vorlagen – AUSGEBLENDET](campaign/using/marketing-campaign-templates.md)
      + {hide-from-toc}[Hinzufügen von Sendungen – AUSGEBLENDET](campaign/using/marketing-campaign-deliveries.md)
      + {hide-from-toc}[Auswählen der Zielgruppe – AUSGEBLENDET](campaign/using/marketing-campaign-target.md)
      + {hide-from-toc}[Verwalten von Dokumenten und Assets – AUSGEBLENDET](campaign/using/marketing-campaign-assets.md)
      + {hide-from-toc}[Einrichten und Verwalten von Validierungen – AUSGEBLENDET](campaign/using/marketing-campaign-approval.md)
      + {hide-from-toc}[Überwachen von Kampagnen – AUSGEBLENDET](campaign/using/marketing-campaign-monitoring.md)
      + {hide-from-toc}[Anbieter, Lager und Budgets – AUSGEBLENDET](campaign/using/providers-stocks-and-budgets.md)
   + Kampagnenoptimierung {#campaign-optimization}
      + {hide-from-toc}[Über Kampagnentypologien – AUSGEBLENDET](campaign-opt/using/about-campaign-typologies.md)
      + {hide-from-toc}[Druckregeln – AUSGEBLENDET](campaign-opt/using/pressure-rules.md)
      + {hide-from-toc}[Konsistenzregeln – AUSGEBLENDET](campaign-opt/using/consistency-rules.md)
      + {hide-from-toc}[Kontrollregeln – AUSGEBLENDET](campaign-opt/using/control-rules.md)
      + {hide-from-toc}[Filterregeln – AUSGEBLENDET](campaign-opt/using/filtering-rules.md)
      + {hide-from-toc}[Anwenden von Regeln – AUSGEBLENDET](campaign-opt/using/applying-rules.md)
      + {hide-from-toc}[Kampagnensimulationen – AUSGEBLENDET](campaign-opt/using/campaign-simulations.md)
+ Verwaltung von Marketing-Ressourcen {#mrm}
   + {hide-from-toc}[Über die Verwaltung von Marketing-Ressourcen – AUSGEBLENDET](mrm/using/about-marketing-resource-management.md)
   + {hide-from-toc}[Erstellen und Verwalten von Aufgaben – AUSGEBLENDET](mrm/using/creating-and-managing-tasks.md)
   + {hide-from-toc}[Kontrollieren der Kosten – AUSGEBLENDET](mrm/using/controlling-costs.md)
   + {hide-from-toc}[Verwalten von Marketing-Ressourcen – AUSGEBLENDET](mrm/using/managing-marketing-resources.md)
   + {hide-from-toc}[Diskussionsforen – AUSGEBLENDET](mrm/using/discussion-forums.md)
+ Verteiltes Marketing {#distributed-marketing}
   + {hide-from-toc}[Über verteiltes Marketing – AUSGEBLENDET](distributed/using/about-distributed-marketing.md)
   + {hide-from-toc}[Erstellen lokaler Kampagnen – AUSGEBLENDET](distributed/using/creating-a-local-campaign.md)
   + {hide-from-toc}[Erstellen partizipativer Kampagnen – AUSGEBLENDET](distributed/using/creating-a-collaborative-campaign.md)
   + {hide-from-toc}[Veröffentlichen des Kampagnenkits – AUSGEBLENDET](distributed/using/publishing-the-campaign-package.md)
   + {hide-from-toc}[Zugreifen auf Kampagnen – AUSGEBLENDET](distributed/using/accessing-campaigns.md)
   + {hide-from-toc}[Nachverfolgen einer Kampagne – AUSGEBLENDET](distributed/using/tracking-a-campaign.md)
   + {hide-from-toc}[Anwendungsfälle – AUSGEBLENDET](distributed/using/examples.md)
...
+ Integrieren mit Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   ...
   + Zielgruppenfreigabe {#audience-sharing}
      ...
      + {hide-from-toc}[Fehlerbehebung](integrations/using/troubleshooting.md)
   ...
   + ACS-Connector {#acs-connector}
      + {hide-from-toc}[Erste Schritte mit [!DNL ACS Connector] – AUSGEBLENDET](integrations/using/acs-connector-principles-and-data-cycle.md)
      + {hide-from-toc}[Synchronisieren von Profilen – AUSGEBLENDET](integrations/using/synchronizing-profiles.md)
      + {hide-from-toc}[Synchronisieren von Zielgruppen – AUSGEBLENDET](integrations/using/synchronizing-audiences.md)
      + {hide-from-toc}[Synchronisieren von Web-Anwendungen – AUSGEBLENDET](integrations/using/synchronizing-web-applications.md)
      + {hide-from-toc}[Fehlerbehebung beim [!DNL ACS Connector] – AUSGEBLENDET](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatisieren mit Workflows {#automating-with-workflows}
   + Erste Schritte mit Workflows {#introduction}
      + {hide-from-toc}[Über Aktivitäten – AUSGEBLENDET](workflow/using/about-activities.md)
      + {hide-from-toc}[Erstellen eines Workflows – AUSGEBLENDET](workflow/using/building-a-workflow.md)
      + {hide-from-toc}[Zieldaten – AUSGEBLENDET](workflow/using/targeting-data.md)
      + {hide-from-toc}[Verwenden von Workflow-Daten – AUSGEBLENDET](workflow/using/how-to-use-workflow-data.md)
      + {hide-from-toc}[Best Practices bei Workflows – AUSGEBLENDET](workflow/using/workflow-best-practices.md)
   + Ausführen eines Workflows {#executing-a-workflow}
      + {hide-from-toc}[Starten eines Workflows – AUSGEBLENDET](workflow/using/starting-a-workflow.md)
      + {hide-from-toc}[Lebenszyklus eines Workflows – AUSGEBLENDET](workflow/using/workflow-life-cycle.md)
      + {hide-from-toc}[Lebenszyklus von Daten – AUSGEBLENDET](workflow/using/data-life-cycle.md)
      + {hide-from-toc}[Definieren von Validierungen – AUSGEBLENDET](workflow/using/defining-approvals.md)
      + {hide-from-toc}[Architektur – AUSGEBLENDET](workflow/using/architecture.md)
   + Zielgruppenbestimmungsaktivitäten {#targeting-activities}
      + {hide-from-toc}[Über Zielgruppenbestimmungsaktivitäten – AUSGEBLENDET](workflow/using/about-targeting-activities.md)
      + {hide-from-toc}[Abfrage – AUSGEBLENDET](workflow/using/query.md)
      + {hide-from-toc}[Inkrementelle Abfrage – AUSGEBLENDET](workflow/using/incremental-query.md)
      + {hide-from-toc}[Liste lesen – AUSGEBLENDET](workflow/using/read-list.md)
      + {hide-from-toc}[Vereinigung – AUSGEBLENDET](workflow/using/union.md)
      + {hide-from-toc}[Schnittmenge – AUSGEBLENDET](workflow/using/intersection.md)
      + {hide-from-toc}[Ausschluss – AUSGEBLENDET](workflow/using/exclusion.md)
      + {hide-from-toc}[Aufspaltung – AUSGEBLENDET](workflow/using/split.md)
      + {hide-from-toc}[Zellen – AUSGEBLENDET](workflow/using/cells.md)
      + {hide-from-toc}[Angebote nach Zelle – AUSGEBLENDET](workflow/using/offers-by-cell.md)
      + {hide-from-toc}[Versandentwurf – AUSGEBLENDET](workflow/using/delivery-outline.md)
      + {hide-from-toc}[Anreicherung – AUSGEBLENDET](workflow/using/enrichment.md)
      + {hide-from-toc}[Bearbeiten des Schemas – AUSGEBLENDET](workflow/using/edit-schema.md)
      + {hide-from-toc}[Angebots-Engine – AUSGEBLENDET](workflow/using/offer-engine.md)
      + {hide-from-toc}[Deduplizierung – AUSGEBLENDET](workflow/using/deduplication.md)
      + {hide-from-toc}[Dimensionsänderung – AUSGEBLENDET](workflow/using/change-dimension.md)
      + {hide-from-toc}[Listen-Update – AUSGEBLENDET](workflow/using/list-update.md)
      + {hide-from-toc}[Listen-Update – AUSGEBLENDET](workflow/using/subscription-services.md)
      + {hide-from-toc}[Aktualisieren von Daten – AUSGEBLENDET](workflow/using/update-data.md)
      + {hide-from-toc}[CRM-Connector – AUSGEBLENDET](workflow/using/crm-connector.md)
      + {hide-from-toc}[Ändern der Datenquelle – AUSGEBLENDET](workflow/using/change-data-source.md)
   + Flusssteuerungsaktivitäten {#flow-control-activities}
      + {hide-from-toc}[Über Flusssteuerungsaktivitäten – AUSGEBLENDET](workflow/using/about-flow-control-activities.md)
      + {hide-from-toc}[Start und Ende – AUSGEBLENDET](workflow/using/start-and-end.md)
      + {hide-from-toc}[Verzweigung – AUSGEBLENDET](workflow/using/fork.md)
      + {hide-from-toc}[UND-Join – AUSGEBLENDET](workflow/using/and-join.md)
      + {hide-from-toc}[Planung – AUSGEBLENDET](workflow/using/scheduler.md)
      + {hide-from-toc}[Test – AUSGEBLENDET](workflow/using/test.md)
      + {hide-from-toc}[Warten – AUSGEBLENDET](workflow/using/wait.md)
      + {hide-from-toc}[Zeitliche Beschränkung – AUSGEBLENDET](workflow/using/time-constraint.md)
      + {hide-from-toc}[Unter-Workflow – AUSGEBLENDET](workflow/using/sub-workflow.md)
      + {hide-from-toc}[Sprung (Start- und Endpunkt – AUSGEBLENDET)](workflow/using/jump-start-point-and-end-point.md)
      + {hide-from-toc}[Externes Signal – AUSGEBLENDET](workflow/using/external-signal.md)
      + {hide-from-toc}[Validierung – AUSGEBLENDET](workflow/using/approval.md)
      + {hide-from-toc}[Warnhinweis – AUSGEBLENDET](workflow/using/alert.md)
      + {hide-from-toc}[Aufgabe – AUSGEBLENDET](workflow/using/task.md)
   + Aktionsaktivitäten {#action-activities}
      + {hide-from-toc}[Über Aktionsaktivitäten – AUSGEBLENDET](workflow/using/about-action-activities.md)
      + {hide-from-toc}[Versand – AUSGEBLENDET](workflow/using/delivery.md)
      + {hide-from-toc}[Versandkontrolle – AUSGEBLENDET](workflow/using/delivery-control.md)
      + {hide-from-toc}[Fortlaufender Versand – AUSGEBLENDET](workflow/using/continuous-delivery.md)
      + {hide-from-toc}[Wiederkehrender Versand – AUSGEBLENDET](workflow/using/recurring-delivery.md)
      + {hide-from-toc}[Kanalübergreifende Sendungen – AUSGEBLENDET](workflow/using/cross-channel-deliveries.md)
      + {hide-from-toc}[Lokale Validierung – AUSGEBLENDET](workflow/using/local-approval.md)
      + {hide-from-toc}[Laden von Daten (RDBMS) – AUSGEBLENDET](workflow/using/data-loading-rdbms.md)
      + {hide-from-toc}[Laden (SOAP) – AUSGEBLENDET](workflow/using/loading-soap.md)
      + {hide-from-toc}[Laden von Daten (Datei) – AUSGEBLENDET](workflow/using/data-loading-file.md)
      + {hide-from-toc}[Content-Management – AUSGEBLENDET](workflow/using/content-management.md)
      + {hide-from-toc}[Datenextraktion (Datei) – AUSGEBLENDET](workflow/using/extraction-file.md)
      + {hide-from-toc}[SQL-Code und JavaScript-Code – AUSGEBLENDET](workflow/using/sql-code-and-javascript-code.md)
      + {hide-from-toc}[SQL-Daten-Management – AUSGEBLENDET](workflow/using/sql-data-management.md)
      + {hide-from-toc}[Nlserver-Modul – AUSGEBLENDET](workflow/using/nlserver-module.md)
      + {hide-from-toc}[Aktualisieren des Aggregats – AUSGEBLENDET](workflow/using/update-aggregate.md)
   + Ereignisaktivitäten {#event-activities}
      + {hide-from-toc}[Über Ereignisaktivitäten – AUSGEBLENDET](workflow/using/about-event-activities.md)
      + {hide-from-toc}[Datei-Wächter – AUSGEBLENDET](workflow/using/file-collector.md)
      + {hide-from-toc}[Dateiübertragung – AUSGEBLENDET](workflow/using/file-transfer.md)
      + {hide-from-toc}[Web-Download – AUSGEBLENDET](workflow/using/web-download.md)
      + {hide-from-toc}[Eingehende E-Mails – AUSGEBLENDET](workflow/using/inbound-emails.md)
      + {hide-from-toc}[Eingehende SMS – AUSGEBLENDET](workflow/using/inbound-sms.md)
   + Anwendungsfälle {#use-cases}
      + {hide-from-toc}[Über Workflow-Anwendungsfälle – AUSGEBLENDET](workflow/using/about-workflow-use-cases.md)
      + Sendungen {#deliveries}
         + {hide-from-toc}[Verwenden der lokalen Validierungsaktivität – AUSGEBLENDET](workflow/using/using-the-local-approval-activity.md)
         + {hide-from-toc}[Senden einer Geburtstags-E-Mail – AUSGEBLENDET](workflow/using/sending-a-birthday-email.md)
         + {hide-from-toc}[Laden des Versandinhalts – AUSGEBLENDET](workflow/using/loading-delivery-content.md)
         + {hide-from-toc}[Workflow für kanalübergreifenden Versand – AUSGEBLENDET](workflow/using/cross-channel-delivery-workflow.md)
         + {hide-from-toc}[E-Mail-Anreicherung mit benutzerdefinierten Datumsfeldern – AUSGEBLENDET](workflow/using/email-enrichment-with-custom-date-fields.md)
   + Monitoring {#monitoring}
      + {hide-from-toc}[Senden eines Berichts an eine Liste – AUSGEBLENDET](workflow/using/sending-a-report-to-a-list.md)
      + {hide-from-toc}[Überwachen Ihrer Workflows – AUSGEBLENDET](workflow/using/supervising-workflows.md)
      + {hide-from-toc}[Senden personalisierter Warnhinweise an Benutzende – AUSGEBLENDET](workflow/using/sending-personalized-alerts-to-operators.md)
   + Daten-Management {#data-management}
      + {hide-from-toc}[Koordinieren von Datenaktualisierungen – AUSGEBLENDET](workflow/using/coordinating-data-updates.md)
      + {hide-from-toc}[Erstellen einer zusammenfassenden Liste – AUSGEBLENDET](workflow/using/creating-a-summary-list.md)
      + {hide-from-toc}[Anreichern von Daten – AUSGEBLENDET](workflow/using/enriching-data.md)
      + {hide-from-toc}[Verwenden von Aggregaten – AUSGEBLENDET](workflow/using/using-aggregates.md)
      + {hide-from-toc}[Verwenden der Zusammenführungsfunktion der Deduplizierungsaktivität – AUSGEBLENDET](workflow/using/deduplication-merge.md)
      + {hide-from-toc}[Einrichten eines Workflows für den wiederkehrenden Import – AUSGEBLENDET](workflow/using/recurring-import-workflow.md)
   + Entwerfen von Abfragen {#designing-queries}
      + {hide-from-toc}[Vierteljährliches Listen-Update mithilfe einer inkrementellen Abfrage – AUSGEBLENDET](workflow/using/quarterly-list-update.md)
   + Abfrage und Filter {#query-and-filter-hidden}
      + {hide-from-toc}[Abfragen der Empfängertabelle – AUSGEBLENDET](workflow/using/querying-recipient-table.md)
      + {hide-from-toc}[Informationen zum Abfrageversand – AUSGEBLENDET](workflow/using/querying-delivery-information.md)
      + {hide-from-toc}[Durchführen von Aggregat-Berechnungen – AUSGEBLENDET](workflow/using/performing-aggregate-computing.md)
      + {hide-from-toc}[Abfrage mit Gruppierungs-Management – AUSGEBLENDET](workflow/using/querying-using-grouping-management.md)
      + {hide-from-toc}[Abfrage mit einer n:n-Beziehung – AUSGEBLENDET](workflow/using/querying-using-many-to-many-relationship.md)
      + {hide-from-toc}[Hinzufügen eines berechneten Auflistungsfelds – AUSGEBLENDET](workflow/using/adding-enumeration-type-calculated-field.md)
      + {hide-from-toc}[Erstellen eines Filters – AUSGEBLENDET](workflow/using/creating-a-filter.md)
      + {hide-from-toc}[Filtern doppelter Empfängerinnen und Empfänger – AUSGEBLENDET](workflow/using/filtering-duplicated-recipients.md)
   + Überwachen von Workflows {#monitoring-workflows}
      + {hide-from-toc}[Überwachen der Workflow-Ausführung – AUSGEBLENDET](workflow/using/monitoring-workflow-execution.md)
      + {hide-from-toc}[Überwachen technischer Workflows – AUSGEBLENDET](workflow/using/monitoring-technical-workflows.md)
      + {hide-from-toc}[Workflow-Heatmap – AUSGEBLENDET](workflow/using/heatmap.md)
   + Fortgeschrittene Verwaltung {#advanced-management}
      + {hide-from-toc}[Workflow-Eigenschaften – AUSGEBLENDET](workflow/using/workflow-properties.md)
      + {hide-from-toc}[Erweiterte Parameter – AUSGEBLENDET](workflow/using/advanced-parameters.md)
      + {hide-from-toc}[JavaScript-Skripts und -Vorlagen – AUSGEBLENDET](workflow/using/javascript-scripts-and-templates.md)
      + {hide-from-toc}[Beispiele für JavaScript-Code in Workflows – AUSGEBLENDET](workflow/using/javascript-in-workflows.md)
      + {hide-from-toc}[Zugreifen auf eine externe Datenbank – AUSGEBLENDET](workflow/using/accessing-an-external-database-fda.md)
      + {hide-from-toc}[Verwalten von Berechtigungen – AUSGEBLENDET](workflow/using/managing-rights.md)
      + {hide-from-toc}[Ändern von Aktivitätsbildern – AUSGEBLENDET](workflow/using/managing-activity-images.md)
      + {hide-from-toc}[Verwalten von Zeitzonen – AUSGEBLENDET](workflow/using/managing-time-zones.md)
      + {hide-from-toc}[Technische Workflows – AUSGEBLENDET](workflow/using/about-technical-workflows.md)
...
+ Handbuch zur Installation und Konfiguration {#installing-campaign-classic}
   ...
   + Konfigurieren von Campaign {#additional-configurations}
      ...
      + {hide-from-toc}[Verwenden von MX-Servern mit Campaign](installation/using/using-mx-servers.md)
   ...
   + Anhänge {#appendices}
      ...
      + {hide-from-toc}[Deinstallieren von Campaign](installation/using/uninstalling-campaign.md)
...
+ Überwachungshandbuch {#monitoring-campaign-classic}
   ...
   + Aktualisieren von Adobe Campaign {#updating-adobe-campaign}
      ...
      + {hide-from-toc}[Migrationsverfahren](production/using/migration-procedures.md)
...
+ Migrationshandbuch {#migrating-to-a-new-version}
   + {hide-from-toc}[Migrieren zu Adobe Campaign v7](migration/using/about-migration.md)
   + Migrationsverfahren {#migration-procedure}
      + {hide-from-toc}[Voraussetzungen](migration/using/before-starting-migration.md)
      + {hide-from-toc}[Über Migrationstests](migration/using/testing-the-migration.md)
      + {hide-from-toc}[Anpassen der Konfiguration](migration/using/configuring-your-platform.md)
   + Starten der Migration {#migrating-to-adobe-campaign-7}
      + {hide-from-toc}[Migrieren einer Microsoft Windows-Plattform](migration/using/migrating-in-windows-for-adobe-campaign-7.md)
      + {hide-from-toc}[Migrieren einer Linux-Plattform](migration/using/migrating-in-linux-for-adobe-campaign-v7.md)
   + {hide-from-toc}[Rollback-Verfahren](migration/using/about-rollback.md)
+ Technotes {#technotes}
   ...
   + Aktualisierungen und Kompatibilität{#technote-migration}
      + {hide-from-toc}[Technische Hinweise](technotes/using/technote.md)
      + [Aktivieren von Microsoft Edge Chromium](technotes/using/edge-chromium.md)
      + {hide-from-toc}[Neuer Zustellbarkeits-Server](technotes/using/deliverability-server.md)
      + {hide-from-toc}[Apache-Sicherheits-Upgrade](technotes/using/acc-apache-upgrade.md)
   ...
   + E-Mails und Push-Benachrichtigungen{#technotes-email}
      ...
      + {hide-from-toc}[Aktualisieren falscher Hardbounces nach einem ISP-Ausfall](delivery/using/update-bounces.md)
      + [Aktualisierung des iOS-Zertifikats](technotes/using/ios-certificate-update.md)
      + {hide-from-toc}[Aktualisierung von getrackten URLs](technotes/using/tracked-urls.md)
