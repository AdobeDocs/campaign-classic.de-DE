...
+ Erste Schritte {#getting-started}
   ...
   + {hide-from-toc}[Campaign-Explorer verwenden - AUSGEBLENDET](platform/using/adobe-campaign-explorer.md)
   + {hide-from-toc}[Listen durchsuchen und anpassen - AUSGEBLENDET](platform/using/adobe-campaign-ui-lists.md)
   + {hide-from-toc}[Auflistungen - HIDDEN](platform/using/managing-enumerations.md)
   ...
   + Profil-Management {#profile-management}
      ...
      + {hide-from-toc}[Profile hinzufügen - AUSGEBLENDET](platform/using/adding-profiles.md)
      + {hide-from-toc}[Profile verwalten - AUSGEBLENDET](platform/using/managing-profiles.md)
   ...
   + Filtern von Daten {#filtering-data}
      ...
      + {hide-from-toc}[Filter erstellen - AUSGEBLENDET](platform/using/creating-filters.md)
   ...
   + {hide-from-toc}[Filterbedingungen definieren - AUSGEBLENDET](platform/using/defining-filter-conditions.md)
   + Berechtigungen {#permissions}
      ...
      + {hide-from-toc}[Zugriff auf Ordner verwalten - AUSGEBLENDET](platform/using/access-management-folders.md)
...
+ Erstellen und Senden von Nachrichten {#sending-messages}
   ...
   + Schnellstart {#key-steps-when-creating-a-delivery}
      ...
      + {hide-from-toc}[Validieren des Versands - AUSGEBLENDET](delivery/using/steps-validating-the-delivery.md)
      + {hide-from-toc}[Versand durchführen - AUSGEBLENDET](delivery/using/steps-sending-the-delivery.md)
      + {hide-from-toc}[Best Practices für den Versand - AUSGEBLENDET](delivery/using/delivery-best-practices.md)
   + Best Practices für den Versand {#delivery-bestpractices}
      + {hide-from-toc}[Versand optimieren - AUSGEBLENDET](delivery/using/optimize-delivery.md)
      + {hide-from-toc}[Verwenden von Vorlagen - AUSGEBLENDET](delivery/using/use-templates.md)
      + {hide-from-toc}[Personalisierte Inhalte erstellen - AUSGEBLENDET](delivery/using/design-and-personalize.md)
      + {hide-from-toc}[Definieren der richtigen Zielgruppe - AUSGEBLENDET](delivery/using/define-the-right-audience.md)
      + {hide-from-toc}[Überprüfen vor dem Senden - AUSGEBLENDET](delivery/using/check-before-sending.md)
   + [Senden von E-Mails](delivery/using/about-email-channel.md)
   + Senden von E-Mails {#sending-emails}
      + {hide-from-toc}[E-Mail-Versand erstellen - AUSGEBLENDET](delivery/using/creating-an-email-delivery.md)
      ...
      + Senden des E-Mail-Versands {#sending-an-email}
         + {hide-from-toc}[Die wichtigsten Schritte zum Senden einer E-Mail - AUSGEBLENDET](delivery/using/sending-messages.md)
         + {hide-from-toc}[E-Mail-Parameter - AUSGEBLENDET](delivery/using/email-parameters.md)
         + {hide-from-toc}[Auf japanischen Mobiltelefonen senden - VERSTECKT](delivery/using/sending-emails-on-japanese-mobiles.md)
      + {hide-from-toc}[Dateien anhängen - AUSGEBLENDET](delivery/using/attaching-files.md)
   + Senden von SMS {#sending-messages-on-mobiles}
      ...
      + {hide-from-toc}[SMS erstellen - AUSGEBLENDET](delivery/using/sms-create.md)
   ...
   + Senden von Push-Benachrichtigungen {#sending-push-notifications}
      + {hide-from-toc}[Integrieren von Campaign SDK in die Mobile App](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
      + Konfigurieren der App{#configure-the-mobile-app}
         + {hide-from-toc}[Erste Schritte mit der App-Konfiguration - AUSGEBLENDET](delivery/using/get-started-app-config.md)
      ...
      + Erstellen einer Push-Benachrichtigung{#create-a-push-msg}
         + {hide-from-toc}[Push-Nachricht für iOS erstellen - AUSGEBLENDET](delivery/using/create-notifications-ios.md)
         + {hide-from-toc}[Push-Nachricht für Android erstellen - AUSGEBLENDET](delivery/using/create-notifications-android.md)
   ...
   + Verwenden von Versandvorlagen {#using-delivery-templates}
      ...
      + {hide-from-toc}[Zielgruppen-Mapping auswählen - AUSGEBLENDET](delivery/using/selecting-a-target-mapping.md)
   ...
   + Personalisieren von Sendungen {#personalizing-deliveries}
      ...
      + {hide-from-toc}[Personalisierte Gutscheine - AUSGEBLENDET](delivery/using/personalized-coupons.md)
      + {hide-from-toc}[Personalisierte PDF-Dokumente erstellen - AUSGEBLENDET](delivery/using/generating-personalized-pdf-documents.md)
      + {hide-from-toc}[Emoticon-Liste anpassen](delivery/using/customizing-emoticon-list.md)
...
+ Orchestrieren von Marketing-Kampagnen {#orchestrating-campaigns}
   + {hide-from-toc}[Über die Kampagnenoptimierung - ausgeblendet](campaign-opt/using/about-campaign-optimization.md)
   + Über Marketing-Kampagnen {#about-marketing-campaigns}
      + {hide-from-toc}[Marketing-Kampagnen entwerfen - AUSGEBLENDET](campaign/using/designing-marketing-campaigns.md)
   ...
   + Orchestrieren von Kampagnen {#orchestrate-campaigns}
      ...
      + {hide-from-toc}[Sendungen hinzufügen - AUSGEBLENDET](campaign/using/marketing-campaign-deliveries.md)
      + {hide-from-toc}[Audience auswählen - AUSGEBLENDET](campaign/using/marketing-campaign-target.md)
      + {hide-from-toc}[Dokumente und Assets verwalten - AUSGEBLENDET](campaign/using/marketing-campaign-assets.md)
      + {hide-from-toc}[Genehmigungen einrichten und verwalten - AUSGEBLENDET](campaign/using/marketing-campaign-approval.md)
      + {hide-from-toc}[Überwachen Ihrer Kampagnen - AUSGEBLENDET](campaign/using/marketing-campaign-monitoring.md)
      + {hide-from-toc}[Anbieter, Lager und Budgets - VERSTECKT](campaign/using/providers-stocks-and-budgets.md)
   + Kampagnenoptimierung {#campaign-optimization}
      ...
      + {hide-from-toc}[Regeln anwenden - AUSGEBLENDET](campaign-opt/using/applying-rules.md)
...
+ Verwaltung von Marketing-Ressourcen {#mrm}
   ...
   + {hide-from-toc}[Aufgaben erstellen und verwalten - AUSGEBLENDET](mrm/using/creating-and-managing-tasks.md)
   + {hide-from-toc}[Kosten kontrollieren - VERSTECKT](mrm/using/controlling-costs.md)
   + {hide-from-toc}[Marketing-Ressourcen verwalten - AUSGEBLENDET](mrm/using/managing-marketing-resources.md)
   + {hide-from-toc}[Diskussionsforen - AUSGEBLENDET](mrm/using/discussion-forums.md)
+ Verteiltes Marketing {#distributed-marketing}
   + {hide-from-toc}[Über dezentrales Marketing - HIDDEN](distributed/using/about-distributed-marketing.md)
   + {hide-from-toc}[Erstellen einer lokalen Kampagne - AUSGEBLENDET](distributed/using/creating-a-local-campaign.md)
   + {hide-from-toc}[Erstellen einer partizipativen Kampagne - AUSGEBLENDET](distributed/using/creating-a-collaborative-campaign.md)
   + {hide-from-toc}[Veröffentlichen des Kampagnenkits - AUSGEBLENDET](distributed/using/publishing-the-campaign-package.md)
   + {hide-from-toc}[Zugriff auf Kampagnen - AUSGEBLENDET](distributed/using/accessing-campaigns.md)
   + {hide-from-toc}[Verfolgen einer Kampagne - AUSGEBLENDET](distributed/using/tracking-a-campaign.md)
...
+ Integrieren mit Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   ...
   + ACS-Connector {#acs-connector}
      ...
      + {hide-from-toc}[Profile synchronisieren - AUSGEBLENDET](integrations/using/synchronizing-profiles.md)
      + {hide-from-toc}[Synchronisieren von Audiences - AUSGEBLENDET](integrations/using/synchronizing-audiences.md)
      + {hide-from-toc}[Synchronisieren von Web-Anwendungen - AUSGEBLENDET](integrations/using/synchronizing-web-applications.md)
      + {hide-from-toc}[Fehlerbehebung bei  [!DNL ACS Connector] - HIDDEN](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatisieren mit Workflows {#automating-with-workflows}
   + Erste Schritte mit Workflows {#introduction}
      ...
      + {hide-from-toc}[Workflow erstellen - AUSGEBLENDET](workflow/using/building-a-workflow.md)
      + {hide-from-toc}[Zielgruppendaten - AUSGEBLENDET](workflow/using/targeting-data.md)
      + {hide-from-toc}[Workflow-Daten verwenden - AUSGEBLENDET](workflow/using/how-to-use-workflow-data.md)
      + {hide-from-toc}[Best Practices für Workflows - AUSGEBLENDET](workflow/using/workflow-best-practices.md)
   + Ausführen eines Workflows {#executing-a-workflow}
      + {hide-from-toc}[Workflow starten - AUSGEBLENDET](workflow/using/starting-a-workflow.md)
      + {hide-from-toc}[Workflow-Lebenszyklus - AUSGEBLENDET](workflow/using/workflow-life-cycle.md)
      + {hide-from-toc}[Datenlebenszyklus - AUSGEBLENDET](workflow/using/data-life-cycle.md)
      + {hide-from-toc}[Genehmigungen definieren - AUSGEBLENDET](workflow/using/defining-approvals.md)
      + {hide-from-toc}[Architektur - VERSTECKT](workflow/using/architecture.md)
   + Zielgruppenbestimmungsaktivitäten {#targeting-activities}
      ...
      + {hide-from-toc}[Angebote pro Segment - AUSGEBLENDET](workflow/using/offers-by-cell.md)
      ...
      + {hide-from-toc}[Schema bearbeiten - AUSGEBLENDET](workflow/using/edit-schema.md)
      + {hide-from-toc}[Angebotsmodul - AUSGEBLENDET](workflow/using/offer-engine.md)
      ...
      + {hide-from-toc}[Abonnement-Services - AUSGEBLENDET](workflow/using/subscription-services.md)
      + {hide-from-toc}[Daten aktualisieren - AUSGEBLENDET](workflow/using/update-data.md)
      + {hide-from-toc}[CRM-Connector - AUSGEBLENDET](workflow/using/crm-connector.md)
      + {hide-from-toc}[Datenquelle ändern - AUSGEBLENDET](workflow/using/change-data-source.md)
   + Flusssteuerungsaktivitäten {#flow-control-activities}
      ...
      + {hide-from-toc}[UND-Verknüpfung - AUSGEBLENDET](workflow/using/and-join.md)
      ...
      + {hide-from-toc}[Zeitbeschränkung - AUSGEBLENDET](workflow/using/time-constraint.md)
      ...
      + {hide-from-toc}[Genehmigung - AUSGEBLENDET](workflow/using/approval.md)
   ...
   + Aktionsaktivitäten {#action-activities}
      ...
      + {hide-from-toc}[Versand (fortlaufend) - AUSGEBLENDET](workflow/using/continuous-delivery.md)
      ...
      + {hide-from-toc}[Laden (RDBMS) - AUSGEBLENDET](workflow/using/data-loading-rdbms.md)
      + {hide-from-toc}[Laden (SOAP) - AUSGEBLENDET](workflow/using/loading-soap.md)
      + {hide-from-toc}[Laden (Datei) - AUSGEBLENDET](workflow/using/data-loading-file.md)
      ...
      + {hide-from-toc}[Aggregat aktualisieren - AUSGEBLENDET](workflow/using/update-aggregate.md)
   + Ereignisaktivitäten {#event-activities}
      ...
      + {hide-from-toc}[HTTP-Übertragung - AUSGEBLENDET](workflow/using/web-download.md)
      + {hide-from-toc}[Eingehende E-Mails - AUSGEBLENDET](workflow/using/inbound-emails.md)
      + {hide-from-toc}[SMS-Empfang - AUSGEBLENDET](workflow/using/inbound-sms.md)
   + Anwendungsfälle {#use-cases}
      + {hide-from-toc}[Über Workflow-Anwendungsfälle - AUSGEBLENDET](workflow/using/about-workflow-use-cases.md)
      + Sendungen {#deliveries}
         + {hide-from-toc}[Verwenden der Aktivität „Lokale Validierung“ - AUSGEBLENDET](workflow/using/using-the-local-approval-activity.md)
         + {hide-from-toc}[Geburtstags-E-Mail senden - AUSGEBLENDET](workflow/using/sending-a-birthday-email.md)
         + {hide-from-toc}[Laden des Versandinhalts - AUSGEBLENDET](workflow/using/loading-delivery-content.md)
         + {hide-from-toc}[Workflow für einen kanalübergreifenden Versand - AUSGEBLENDET](workflow/using/cross-channel-delivery-workflow.md)
   ...
   + Monitoring {#monitoring}
      ...
      + {hide-from-toc}[Senden personalisierter Warnungen an Benutzer - AUSGEBLENDET](workflow/using/sending-personalized-alerts-to-operators.md)
   ...
   + Abfrage und Filter {#query-and-filter-hidden}
      + {hide-from-toc}[Empfängertabelle abfragen - AUSGEBLENDET](workflow/using/querying-recipient-table.md)
      + {hide-from-toc}[Informationen zum Abfrageversand - AUSGEBLENDET](workflow/using/querying-delivery-information.md)
      + {hide-from-toc}[Aggregat berechnen - AUSGEBLENDET](workflow/using/performing-aggregate-computing.md)
      + {hide-from-toc}[Abfrage mit Gruppierungsverwaltung - AUSGEBLENDET](workflow/using/querying-using-grouping-management.md)
      ...
      + {hide-from-toc}[Filter erstellen - AUSGEBLENDET](workflow/using/creating-a-filter.md)
      + {hide-from-toc}[Filtern doppelter Empfänger - AUSGEBLENDET](workflow/using/filtering-duplicated-recipients.md)
   ...
   + Fortgeschrittene Verwaltung {#advanced-management}
      ...
      + {hide-from-toc}[JavaScript-Skripte und -Vorlagen - AUSGEBLENDET](workflow/using/javascript-scripts-and-templates.md)
      + {hide-from-toc}[Beispiele für JavaScript-Code in Workflows - AUSGEBLENDET](workflow/using/javascript-in-workflows.md)
      + {hide-from-toc}[Zugriff auf eine externe Datenbank - AUSGEBLENDET](workflow/using/accessing-an-external-database-fda.md)
      + {hide-from-toc}[Berechtigungen verwalten - AUSGEBLENDET](workflow/using/managing-rights.md)
      + {hide-from-toc}[Ändern von Aktivitätsbildern - AUSGEBLENDET](workflow/using/managing-activity-images.md)
      + {hide-from-toc}[Zeitzonen verwalten - AUSGEBLENDET](workflow/using/managing-time-zones.md)
...
+ Handbuch zur Installation und Konfiguration  {#installing-campaign-classic}
   ...
   + Anhänge {#appendices}
      ...
      + {hide-from-toc}[Campaign deinstallieren](installation/using/uninstalling-campaign.md)
...
+ Migrationshandbuch {#migrating-to-a-new-version}
   ...
   + Migrationsverfahren {#migration-procedure}
      ...
      + {hide-from-toc}[Passen Sie Ihre Konfiguration an](migration/using/configuring-your-platform.md)
...
+ Technotes {#technotes}
   ...
   + Aktualisierungen und Kompatibilität{#technote-migration}
      + {hide-from-toc}[Technotes](technotes/using/technote.md)
      + [Aktivieren von Microsoft Edge Chromium](technotes/using/edge-chromium.md)
      + {hide-from-toc}[Neuer Zustellbarkeitsserver](technotes/using/deliverability-server.md)
      ...
      + {hide-from-toc}[Einstellung der Unterstützung für TLS 1.0 und 1.1](technotes/using/eol-tls-support.md)
   + E-Mails und Push-Benachrichtigungen{#technotes-email}
      ...
      + {hide-from-toc}[Aktualisierung der getrackten URLs](technotes/using/tracked-urls.md)
