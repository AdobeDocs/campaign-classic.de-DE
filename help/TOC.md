...
+ Erste Schritte {#getting-started}
   ...
   + [Verwenden des Campaign-Explorers](platform/using/adobe-campaign-explorer.md)
   ...
   + [Glossar – AUSGEBLENDET](platform/using/ac-glossary.md)
   + Datenschutz {#privacy}
   ...
   + Profil-Management {#profile-management}
      ...
      + [Bearbeiten von Profilen – AUSGEBLENDET](platform/using/editing-a-profile.md)
      + [Hinzufügen von Profilen – AUSGEBLENDET](platform/using/adding-profiles.md)
      + [Verwalten von Profilen – AUSGEBLENDET](platform/using/managing-profiles.md)
      + [Aktualisieren von Daten](platform/using/updating-data.md)
      + [Importieren und Exportieren von Profilen – AUSGEBLENDET](platform/using/exporting-and-importing-profiles.md)
   ...
   + Filtern von Daten {#filtering-data}
      ...
      + [Erstellen von Filtern – AUSGEBLENDET](platform/using/creating-filters.md)
   ...
   + [Definieren von Filterbedingungen – AUSGEBLENDET](platform/using/defining-filter-conditions.md)
   + Berechtigungen {#permissions}
      ...
      + [Verwalten des Zugriffs auf Ordner – AUSGEBLENDET](platform/using/access-management-folders.md)
...
+ Erstellen und Senden von Nachrichten {#sending-messages}
   ...
   + [Versandeinstellungen – AUSGEBLENDET](delivery/using/delivery-settings.md)
   + Schnellstart {#key-steps-when-creating-a-delivery}
      ...
      + [Erstellen und Identifizieren eines Versands – AUSGEBLENDET](delivery/using/steps-create-and-identify-the-delivery.md)
      + [Definieren der Zielgruppe – AUSGEBLENDET](delivery/using/steps-defining-the-target-population.md)
      + [Überprüfen des Versands – AUSGEBLENDET](delivery/using/steps-validating-the-delivery.md)
      + [Senden des Versands – AUSGEBLENDET](delivery/using/steps-sending-the-delivery.md)
      + [Best Practices beim Versand – AUSGEBLENDET](delivery/using/delivery-best-practices.md)
   + Best Practices beim Versand {#delivery-bestpractices}
      + [Optimieren des Versands – AUSGEBLENDET](delivery/using/optimize-delivery.md)
      + [Verwenden von Vorlagen – AUSGEBLENDET](delivery/using/use-templates.md)
   ...
   + Senden von E-Mails {#sending-emails}
      ...
      + Senden des E-Mail-Versands {#sending-an-email}
         ...
         + [E-Mail-Parameter – AUSGEBLENDET](delivery/using/email-parameters.md)
         + [Senden auf japanischen Mobiltelefonen – AUSGEBLENDET](delivery/using/sending-emails-on-japanese-mobiles.md)
      + [Anhängen von Dateien – AUSGEBLENDET](delivery/using/attaching-files.md)
   + Senden von SMS {#sending-messages-on-mobiles}
      ...
      + [Erstellen einer SMS – AUSGEBLENDET](delivery/using/sms-create.md)
   ...
   + Senden von Push-Benachrichtigungen {#sending-push-notifications}
      + [Integrieren des Campaign-SDK in die App](delivery/using/integrating-campaign-sdk-into-the-mobile-application.md)
      + Konfigurieren der App{#configure-the-mobile-app}
         + [Erste Schritte bei der App-Konfiguration – AUSGEBLENDET](delivery/using/get-started-app-config.md)
         + [Konfigurationsschritte für iOS – AUSGEBLENDET](delivery/using/configuring-the-mobile-application.md)
         + [Konfigurationsschritte für Android – AUSGEBLENDET](delivery/using/configuring-the-mobile-application-android.md)
      + Erstellen einer Push-Benachrichtigung{#create-a-push-msg}
         + [Erstellen einer Push-Benachrichtigung für iOS – AUSGEBLENDET](delivery/using/create-notifications-ios.md)
         + [Erstellen einer Push-Benachrichtigung für Android – AUSGEBLENDET](delivery/using/create-notifications-android.md)
   ...
   + Senden von Briefpost {#sending-direct-mail}
      + [Erstellen eines Briefpost-Versands – AUSGEBLENDET](delivery/using/creating-a-direct-mail-delivery.md)
   ...
   + Verwenden von Versandvorlagen {#using-delivery-templates}
      ...
      + [Auswählen eines Zielgruppen-Mappings – AUSGEBLENDET](delivery/using/selecting-a-target-mapping.md)
   ...
   + Personalisieren von Sendungen {#personalizing-deliveries}
      ...
      + [Beispiel für Personalisierungsfelder – AUSGEBLENDET](delivery/using/personalization-fields.md)
      + [Gestaltungsbausteine – AUSGEBLENDET](delivery/using/personalization-blocks.md)
      + [Bedingter Inhalt – AUSGEBLENDET](delivery/using/conditional-content.md)
      + [Personalisierte Coupons – AUSGEBLENDET](delivery/using/personalized-coupons.md)
      + [Generieren personalisierter PDF-Dokumente – AUSGEBLENDET](delivery/using/generating-personalized-pdf-documents.md)
...
+ Orchestrieren von Marketing-Kampagnen {#orchestrating-campaigns}
   + [Über Kampagnenoptimierung – AUSGEBLENDET](campaign-opt/using/about-campaign-optimization.md)
   + Über Marketing-Kampagnen {#about-marketing-campaigns}
      ...
      + [Zugreifen auf Marketing-Kampagnen – AUSGEBLENDET](campaign/using/accessing-marketing-campaigns.md)
   + Orchestrieren von Kampagnen {#orchestrate-campaigns}
      ...
      + [Erstellen und Konfigurieren von Vorlagen – AUSGEBLENDET](campaign/using/marketing-campaign-templates.md)
      + [Hinzufügen von Sendungen – AUSGEBLENDET](campaign/using/marketing-campaign-deliveries.md)
      + [Auswählen der Zielgruppe – AUSGEBLENDET](campaign/using/marketing-campaign-target.md)
      + [Verwalten von Dokumenten und Assets – AUSGEBLENDET](campaign/using/marketing-campaign-assets.md)
      + [Einrichten und Verwalten von Validierungen – AUSGEBLENDET](campaign/using/marketing-campaign-approval.md)
      + [Überwachen von Kampagnen – AUSGEBLENDET](campaign/using/marketing-campaign-monitoring.md)
      + [Dienstleister, Lager und Budgets – AUSGEBLENDET](campaign/using/providers-stocks-and-budgets.md)
   + Kampagnenoptimierung {#campaign-optimization}
      + [Über Kampagnentypologien – AUSGEBLENDET](campaign-opt/using/about-campaign-typologies.md)
      ...
      + [Anwenden von Regeln – AUSGEBLENDET](campaign-opt/using/applying-rules.md)
      + [Kampagnensimulationen – AUSGEBLENDET](campaign-opt/using/campaign-simulations.md)
+ Verwaltung von Marketing-Ressourcen {#mrm}
   + [Über die Verwaltung von Marketing-Ressourcen – AUSGEBLENDET](mrm/using/about-marketing-resource-management.md)
   + [Erstellen und Verwalten von Aufgaben – AUSGEBLENDET](mrm/using/creating-and-managing-tasks.md)
   + [Kontrollieren der Kosten – AUSGEBLENDET](mrm/using/controlling-costs.md)
   + [Verwalten von Marketing-Ressourcen – AUSGEBLENDET](mrm/using/managing-marketing-resources.md)
   + [Diskussionsforen – AUSGEBLENDET](mrm/using/discussion-forums.md)
+ Verteiltes Marketing {#distributed-marketing}
   + [Über verteiltes Marketing – AUSGEBLENDET](distributed/using/about-distributed-marketing.md)
   + [Erstellen lokaler Kampagnen – AUSGEBLENDET](distributed/using/creating-a-local-campaign.md)
   + [Erstellen partizipativer Kampagnen – AUSGEBLENDET](distributed/using/creating-a-collaborative-campaign.md)
   + [Veröffentlichen des Kampagnenpakets – AUSGEBLENDET](distributed/using/publishing-the-campaign-package.md)
   + [Zugreifen auf Kampagnen – AUSGEBLENDET](distributed/using/accessing-campaigns.md)
   + [Nachverfolgen einer Kampagne – AUSGEBLENDET](distributed/using/tracking-a-campaign.md)
...
+ Integrieren mit Adobe Experience Cloud {#integrating-with-adobe-experience-cloud}
   ...
   + ACS-Connector {#acs-connector}
      ...
      + [Synchronisieren von Profilen – AUSGEBLENDET](integrations/using/synchronizing-profiles.md)
      + [Synchronisieren von Zielgruppen – AUSGEBLENDET](integrations/using/synchronizing-audiences.md)
      + [Synchronisieren von Web-Anwendungen – AUSGEBLENDET](integrations/using/synchronizing-web-applications.md)
      + [Fehlerbehebung bei [!DNL ACS Connector] – AUSGEBLENDET](integrations/using/troubleshooting-the-acs-connector.md)
...
+ Automatisieren mit Workflows {#automating-with-workflows}
   + Erste Schritte mit Workflows {#introduction}
      + [Über Aktivitäten – AUSGEBLENDET](workflow/using/about-activities.md)
      + [Erstellen eines Workflows – AUSGEBLENDET](workflow/using/building-a-workflow.md)
      + [Zieldaten – AUSGEBLENDET](workflow/using/targeting-data.md)
      + [Verwenden von Workflow-Daten – AUSGEBLENDET](workflow/using/how-to-use-workflow-data.md)
      + [Best Practices bei Workflows – AUSGEBLENDET](workflow/using/workflow-best-practices.md)
   + Ausführen eines Workflows {#executing-a-workflow}
      + [Starten eines Workflows – AUSGEBLENDET](workflow/using/starting-a-workflow.md)
      + [Lebenszyklus eines Workflows – AUSGEBLENDET](workflow/using/workflow-life-cycle.md)
      + [Lebenszyklus von Daten – AUSGEBLENDET](workflow/using/data-life-cycle.md)
      + [Definieren von Validierungen – AUSGEBLENDET](workflow/using/defining-approvals.md)
      + [Architektur – AUSGEBLENDET](workflow/using/architecture.md)
   + Zielgruppenbestimmungsaktivitäten {#targeting-activities}
      + [Über Zielgruppenbestimmungsaktivitäten – AUSGEBLENDET](workflow/using/about-targeting-activities.md)
      ...
      + [Ausschluss – AUSGEBLENDET](workflow/using/exclusion.md)
      + [Aufspaltung – AUSGEBLENDET](workflow/using/split.md)
      + [Zellen – AUSGEBLENDET](workflow/using/cells.md)
      + [Angebote nach Zelle – AUSGEBLENDET](workflow/using/offers-by-cell.md)
      + [Versandentwurf – AUSGEBLENDET](workflow/using/delivery-outline.md)
      + [Anreicherung – AUSGEBLENDET](workflow/using/enrichment.md)
      + [Bearbeiten des Schemas – AUSGEBLENDET](workflow/using/edit-schema.md)
      + [Angebots-Engine – AUSGEBLENDET](workflow/using/offer-engine.md)
      + [Deduplizierung – AUSGEBLENDET](workflow/using/deduplication.md)
      + [Ändern der Dimension – AUSGEBLENDET](workflow/using/change-dimension.md)
      + [Listen-Update – AUSGEBLENDET](workflow/using/list-update.md)
      + [Abonnementdienste – AUSGEBLENDET](workflow/using/subscription-services.md)
      + [Aktualisieren von Daten – AUSGEBLENDET](workflow/using/update-data.md)
      + [CRM-Connector – AUSGEBLENDET](workflow/using/crm-connector.md)
      + [Ändern der Datenquelle – AUSGEBLENDET](workflow/using/change-data-source.md)
   + Flusssteuerungsaktivitäten {#flow-control-activities}
      ...
      + [Verzweigung – AUSGEBLENDET](workflow/using/fork.md)
      + [UND-Join – AUSGEBLENDET](workflow/using/and-join.md)
      + [Planung – AUSGEBLENDET](workflow/using/scheduler.md)
      ...
      + [Externes Signal – AUSGEBLENDET](workflow/using/external-signal.md)
      + [Validierung – AUSGEBLENDET](workflow/using/approval.md)
      + [Warnhinweis – AUSGEBLENDET](workflow/using/alert.md)
   ...
   + Aktionsaktivitäten {#action-activities}
      ...
      + [Wiederkehrender Versand – AUSGEBLENDET](workflow/using/recurring-delivery.md)
      ...
      + [Laden (SOAP) – AUSGEBLENDET](workflow/using/loading-soap.md)
      + [Laden (Datei) – AUSGEBLENDET](workflow/using/data-loading-file.md)
      + [Content-Management – AUSGEBLENDET](workflow/using/content-management.md)
      + [Extrahieren von Daten (Datei) – AUSGEBLENDET](workflow/using/extraction-file.md)
      ...
      + [Nlserver-Modul – AUSGEBLENDET](workflow/using/nlserver-module.md)
      + [Aktualisieren des Aggregats – AUSGEBLENDET](workflow/using/update-aggregate.md)
   + Ereignisaktivitäten {#event-activities}
      + [Über Ereignisaktivitäten – AUSGEBLENDET](workflow/using/about-event-activities.md)
      + [Datei-Wächter – AUSGEBLENDET](workflow/using/file-collector.md)
      + [Dateiübertragung – AUSGEBLENDET](workflow/using/file-transfer.md)
      + [Webdownload – AUSGEBLENDET](workflow/using/web-download.md)
      + [Eingehende E-Mails – AUSGEBLENDET](workflow/using/inbound-emails.md)
      + [Eingehende SMS – AUSGEBLENDET](workflow/using/inbound-sms.md)
   + Anwendungsfälle {#use-cases}
      ...
      + Sendungen {#deliveries}
         ...
         + [Senden einer Geburtstags-E-Mail – AUSGEBLENDET](workflow/using/sending-a-birthday-email.md)
         + [Laden des Versandinhalts – AUSGEBLENDET](workflow/using/loading-delivery-content.md)
         + [Workflow für kanalübergreifenden Versand – AUSGEBLENDET](workflow/using/cross-channel-delivery-workflow.md)
         + [E-Mail-Anreicherung mit benutzerdefinierten Datumsfeldern – AUSGEBLENDET](workflow/using/email-enrichment-with-custom-date-fields.md)
   + Monitoring {#monitoring}
      + [Senden eines Berichts an eine Liste – AUSGEBLENDET](workflow/using/sending-a-report-to-a-list.md)
      + [Überwachen Ihrer Workflows – AUSGEBLENDET](workflow/using/supervising-workflows.md)
      + [Senden personalisierter Warnhinweise an Benutzerinnen und Benutzer – AUSGEBLENDET](workflow/using/sending-personalized-alerts-to-operators.md)
   + Daten-Management {#data-management}
      + [Koordinieren von Datenaktualisierungen – AUSGEBLENDET](workflow/using/coordinating-data-updates.md)
      ...
      + [Verwenden von Aggregaten – AUSGEBLENDET](workflow/using/using-aggregates.md)
      + [Verwenden der Zusammenführungsfunktion der Deduplizierungsaktivität – AUSGEBLENDET](workflow/using/deduplication-merge.md)
   ...
   + Abfrage und Filter {#query-and-filter-hidden}
      ...
      + [Abfrage mit Gruppierungs-Management – AUSGEBLENDET](workflow/using/querying-using-grouping-management.md)
      + [Abfrage mit einer n:n-Beziehung – AUSGEBLENDET](workflow/using/querying-using-many-to-many-relationship.md)
      + [Hinzufügen eines berechneten Aufzählungsfelds – AUSGEBLENDET](workflow/using/adding-enumeration-type-calculated-field.md)
      + [Erstellen eines Filters – AUSGEBLENDET](workflow/using/creating-a-filter.md)
      + [Filtern doppelter Empfängerinnen und Empfänger – AUSGEBLENDET](workflow/using/filtering-duplicated-recipients.md)
   + Überwachen von Workflows {#monitoring-workflows}
      + [Überwachen der Workflow-Ausführung – AUSGEBLENDET](workflow/using/monitoring-workflow-execution.md)
      + [Überwachen technischer Workflows – AUSGEBLENDET](workflow/using/monitoring-technical-workflows.md)
      + [Workflow-Heatmap – AUSGEBLENDET](workflow/using/heatmap.md)
   + Fortgeschrittene Verwaltung {#advanced-management}
      + [Workflow-Eigenschaften – AUSGEBLENDET](workflow/using/workflow-properties.md)
      + [Erweiterte Parameter – AUSGEBLENDET](workflow/using/advanced-parameters.md)
      + [JavaScript-Skripts und -Vorlagen – AUSGEBLENDET](workflow/using/javascript-scripts-and-templates.md)
      + [Beispiele für JavaScript-Code in Workflows – AUSGEBLENDET](workflow/using/javascript-in-workflows.md)
      + [Zugreifen auf eine externe Datenbank – AUSGEBLENDET](workflow/using/accessing-an-external-database-fda.md)
      + [Verwalten von Berechtigungen – AUSGEBLENDET](workflow/using/managing-rights.md)
      + [Ändern von Aktivitätsbildern – AUSGEBLENDET](workflow/using/managing-activity-images.md)
      + [Verwalten von Zeitzonen – AUSGEBLENDET](workflow/using/managing-time-zones.md)
      + [Technische Workflows – AUSGEBLENDET](workflow/using/about-technical-workflows.md)
