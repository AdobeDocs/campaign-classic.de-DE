...
<table>
    ...
    <td valign="top">
        ...
        <li><a href="delivery/using/delivery-performance-troubleshooting.md">Versand-Performance</a></li>
        ...
        <li><a href="delivery/using/delivery-failures-quarantine.md">Ursachen für das Fehlschlagen von Sendungen</a></li>
        </ul>
    </td>
   <td valign="top">
        <ul>
