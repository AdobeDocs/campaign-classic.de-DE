...
>[!NOTE]
>
>Sie können die im Datenschema definierte Beschriftung überladen, indem Sie das **label** -Attribut zum `<input>` Element hinzufügen:\
...
Die Bilder sind über den **[!UICONTROL Administration > Configuration > Images]** Knoten verfügbar.

#### Sichtbarkeitsbehälter {#visibility-container}
...
Beachten Sie, dass ein Link wie folgt im Datenschema deklariert wird:
...
Die Zielauswahl kann über das Bearbeitungsfeld aufgerufen werden. Die Eingabe wird von type-ahead unterstützt, damit ein Zielelement aus den ersten eingegebenen Zeichen leicht zu finden ist. Die Suche basiert dann auf der im Zielschema definierten **Berechnen-Zeichenfolge** . Wenn das Schema nach der Überprüfung im Steuerelement nicht vorhanden ist, wird eine Meldung zur Bestätigung der spontanen Zielerstellung angezeigt. Die Bestätigung erstellt einen neuen Datensatz in der Zieltabelle und verknüpft ihn mit dem Link.

Eine Dropdownliste wird verwendet, um ein Zielelement aus der Liste der bereits erstellten Datensätze auszuwählen.

Das Symbol **[!UICONTROL Modify the link]** (Ordner) startet ein Auswahlformular mit der Liste der Zielelemente und einer Filterzone:

![](assets/d_ncs_integration_form_exemple10.png)

Das **[!UICONTROL Edit link]** (Vergrößerungssymbol) startet das Bearbeitungsformular des verknüpften Elements. Das verwendete Formular wird standardmäßig auf den Schlüssel des Zielschemas abgezogen. Mit dem **form** -Attribut können Sie den Namen des Bearbeitungsformulars erzwingen (z. &quot;cus:company2&quot;).
...
Ein Link, der im Datenschema als Sammlungselement (unbound=&quot;true&quot;) eingegeben wird, muss eine Liste durchlaufen, um alle damit verknüpften Elemente anzuzeigen.
...
Die Liste in ihrem Eingabefeld:
...
List control wird durch das **Attribut type=&quot;linklist&quot;** definiert. Der Listenpfad muss auf den Sammlungslink verweisen.

The columns are declared via the **`<input>`** elements of the list. Das **xpath** -Attribut verweist auf den Pfad des Felds im Zielschema.

Eine Symbolleiste mit einer Beschriftung (definiert auf dem Link im Schema) wird automatisch über der Liste platziert.

Die Liste kann über die **[!UICONTROL Filters]** Schaltfläche gefiltert und so konfiguriert werden, dass die Spalten hinzugefügt und sortiert werden.

Mit den Schaltflächen **[!UICONTROL Add]** und **[!UICONTROL Delete]** können Sie Sammlungselemente zum Link hinzufügen und löschen. Beim Hinzufügen eines Elements wird standardmäßig das Bearbeitungsformular des Zielschemas gestartet.

Die **[!UICONTROL Detail]** Schaltfläche wird automatisch hinzugefügt, wenn das Attribut **zoom=&quot;true&quot;** im **`<input>`** Tag der Liste abgeschlossen ist: Dadurch können Sie das Bearbeitungsformular der ausgewählten Zeile starten.
...
Wenn Sie ein Element zur Liste hinzufügen, können Sie daher eine Liste aus einem der beiden Links in der Beziehungstabelle ausfüllen.
...
Für unser Beispiel beginnen wir mit dem Eingabedatum des Schemas &quot;cus:empfänger&quot;. Die Liste muss die Verbindungen mit Abonnements für Dienste anzeigen und Sie müssen ein Abonnement hinzufügen können, indem Sie einen vorhandenen Dienst auswählen.
...
* **form**: überschreibt das Bearbeitungsformular des Zielelements
* **zoom**: fügt die **[!UICONTROL Zoom]** Schaltfläche zum Bearbeiten des Zielelements hinzu
...
Das Bearbeitungsformular wird aus dem `<form>` Element unter Listendefinition ausgefüllt. Die Struktur des Formulars ist identisch mit der eines Eingabefelds. Die **[!UICONTROL Detail]** Schaltfläche wird automatisch hinzugefügt, wenn das Attribut **zoom=&quot;true&quot;** auf dem **`<input>`** Tag der Liste abgeschlossen ist. Mit diesem Attribut können Sie das Bearbeitungsformular der ausgewählten Zeile starten.
...
Über die **[!UICONTROL Finish]** Schaltfläche werden die eingegebenen Daten gespeichert und das Formular geschlossen.
