...
Der Einstiegspunkt des Schemas ist sein Hauptelement. Es ist leicht identifizierbar, da sein Name mit dem des Schemas identisch ist. Außerdem handelt es sich um das direkt dem Stamm untergeordnete Element. Die Beschreibung des Inhalts beginnt mit diesem Element.
...
Um einen Standardwert mit einem Feld zu verknüpfen, können Sie das Feld `<default>` oder `<sqldefault>` verwenden.
