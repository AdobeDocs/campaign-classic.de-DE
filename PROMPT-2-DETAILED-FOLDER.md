...
---
# EINGABEAUFFORDERUNG 2: Details zum Ordner analysieren

**Genère un rapport Markdown détaillé pour un folder avec % de match**
...
1. **Kopieren Sie die gesamte obige Eingabeaufforderung**
2. **Ordnerpfad ersetzen**:

   ```
   📁 **Analyze**: /Users/.../help/[YOUR-FOLDER]/using/
   ```

3. **Einfügen in Cursor**
4. **Analyse ausführen**
5. **Abrufen des vollständigen Markdown-Berichts**
6. **Speichern unter**: `[folder]-detailed-analysis.md`
...
- `/help/workflow/using/` (121 Dateien)
- `/help/platform/using/` (61 Dateien)
- `/help/web/using/` (26 Dateien)

&#x200B;---

## AUSGABEVORSCHAU

Der Bericht umfasst ca. 30-40 Seiten mit einem detaillierten Markdown mit:
- Zusammenfassungsstatus
- Vollständige Tabelle mit allen Dateien
- Bis zu 3 v8-Treffer pro Datei
- Übereinstimmungsprozentsätze
- Detaillierte Zusammenfassungen der Dateien
- Sanierungsplan
- Aktionselemente

Perfekt für die Ausführung! ✅
